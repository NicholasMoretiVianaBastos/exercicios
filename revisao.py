...
def mostrar_roupas(receber_roupa):
    if receber_roupa:
        for data_roupa in receber_roupa:
            print(f"""
                ID da Roupa: {data_roupa["id_roupa"]}
                Nome da Roupa: {data_roupa["nome_roupa"]}
                Descrição da Roupa: {data_roupa["descricao_roupa"]}
                Tamanho: {data_roupa["tamanho"]}
                Cor: {data_roupa["cor"]}
                Valor: {data_roupa["valor"]}
                Quantidade: {data_roupa["quantidade"]}
            """)
    else:
